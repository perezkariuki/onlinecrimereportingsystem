...
if(isset($_POST['Submit'])) {	
	...
	if(empty($nameoff) || empty($offno)|| empty($fbstate)) {
		...
		if(empty($offno)) {
			echo "<font color='red'>Officer Serialno. field is empty.</font><br/>";
		}
		if(empty($fbstate)) {
		...
		$result = mysqli_query($mysqli, "INSERT INTO feedback(nameoff, offno,fbstate,off_pid) VALUES('$nameoff','$offno','$fbstate','$off_pid')");
...
?>
	<div class="titl"><br/>
	<h1>Add Feedback</h1><br/>
	</div>
	<a href="feedv.php" class="btn">View Statement</a><br/><br/>
	<div>
	<form action="" method="post" name="form1">
		<table width="48%" border="0" class="portal" align="center">
			<tr> 
				<td>officer name</td>
				<td><input type="text" name="nameoff" placeholder="Officer name"></td>
			</tr>
			<tr> 
				<td>officer serialno.</td>
				<td><input type="text" name="offno" placeholder=" Enter serial no."></td>
			</tr>
			<tr> 
				<td>report feedback</td>
				<td><input type="text" name="fbstate" placeholder="Enter statement feedback"></td>
			</tr>
			<tr> 
				<td></td>
